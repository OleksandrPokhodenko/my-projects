(() => {
    ...
    function initSliders() {
        if (document.querySelector(".unsplash-graphic-section__slider")) new swiper_core_Swiper(".unsplash-graphic-section__slider", {
            modules: [ Scrollbar ],
            observer: true,
            observeParents: true,
            autoHeight: true,
            ...
            scrollbar: {
                snapOnRelease: true,
                el: ".unsplash-graphic-section__scrollbar",
                draggable: true,
                dragSize: 50
            },
            breakpoints: {
        ...
        if (document.querySelector(".enjoy-this-product-section__slider")) new swiper_core_Swiper(".enjoy-this-product-section__slider", {
