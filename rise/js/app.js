(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hero-section__slider")) new swiper_core_Swiper(".hero-section__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 6,
        ...
        if (document.querySelector(".ready-to-use-section__slider")) new swiper_core_Swiper(".ready-to-use-section__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.42,
        ...
        if (document.querySelector(".testimonial-section__slider")) new swiper_core_Swiper(".testimonial-section__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
